...
import android.os.SystemProperties; //added for psensor gesture
...
public class RestoreRotationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
		...
		//added for psensor gesture
        if (SystemProperties.get("ro.hct_ps_guest").equals("1") && action.equals(Intent.ACTION_BOOT_COMPLETED)){
            com.android.settings.HctPsensorGestureMotion.switchPsSensor();
