...
public class DeviceInfoSettingsExts {
    ...
    private void initBasebandVersion() {
        ...
        //if (hasExternalModem && !FeatureOption.PURE_AP_USE_EXTERNAL_MODEM) { //chenyichong disabled temp.
        if (false) {
            ...
            if (FeatureOption.MTK_C2K_SUPPORT) {
                ...
                baseband2 = "gsm.version.baseband1";
            }
    ...
    {
        boolean result = mActivity.getResources().getBoolean(R.bool.hct_basebrand_version_enable);
        return result;
    }
