...
public class AudioProfileSettings extends SettingsPreferenceFragment implements
	...
	private static AudioManager mAudioManager; //add by weixiaohui.hct
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAudioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE); //add by weixiaohui.hct
        ...
        if (button != DialogInterface.BUTTON_POSITIVE) {
		   ...
		   //+add by weixiaohui.hct
			if(SystemProperties.get("ro.hct_vibrate_time_setting").equals("1")){
			     Settings.System.putInt(getContentResolver(), "virbate_time_setting", 0);
				}			
			if(mContext.getResources().getBoolean(R.bool.hct_show_meida_volume)){
				 mAudioManager.setStreamVolume(AudioSystem.STREAM_MUSIC, 12, 0);
			   }
			//-add by weixiaohui.hct	
