...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    public void onPause() {
		...
		//hct mocong modify here Bluetooth interface can not be found to Bluetooth 20150611
    ...
    public void onBluetoothStateChanged(int bluetoothState) {
        ...
        /// M: Reset ScanMode to make sure device can be scaned out after re-enable BT.@{
	//hct mocong modify here Bluetooth interface can not be found to Bluetooth 20150611
    ...
    private final View.OnClickListener mDeviceProfilesListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            ///M: ALPS01849536
            if (profileFragment == null || !profileFragment.isInLayout()) {
                LayoutInflater inflater = getActivity().getLayoutInflater();
                Log.d(TAG, "LayoutInflater inflate the dialog fragment");
                ...
                /// M: ALPS01849600 {@
                if (mSettingsDialogView == null || header == null) {
                    Log.d(TAG, "Layout inflate fail, just exit");
                    return ;
                }
                /// @}
            ...
            settingsDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                public void onDismiss(final DialogInterface dialog) {
                    if (!activity.isDestroyed()) {
                        ...
                        Log.d(TAG, "Remove the fragment view");
                    }
                }
            });

            final AlertDialog dialog = settingsDialog.create();
            mProfileDialog = dialog;
            ...
            deviceName.addTextChangedListener(new TextWatcher() {
                public void afterTextChanged(Editable s) {
                    ...
                    dialog.getButton(AlertDialog.BUTTON_POSITIVE).setEnabled(isEffective);
                }
            ...
            dialog.create();
            dialog.show();
            Log.d(TAG, "Show the Alert dialog");
