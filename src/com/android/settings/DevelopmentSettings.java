...
public class DevelopmentSettings extends SettingsPreferenceFragment
	...
	//add by zhangjunjun for development only display three item 20150618

		if (getResources().getBoolean(R.bool.hct_development_only_display_three_item)) {			
        getPreferenceScreen().removeAll();
        getPreferenceScreen().addPreference(mEnableAdb);
        getPreferenceScreen().addPreference(mKeepScreenOn);
        getPreferenceScreen().addPreference(mAllowMockLocation);
        }
		//add by zhangjunjun for development only display three item 20150618
    }
    ...
    public void onResume() {
        ...
        if (mHaveDebugSettings && !mLastEnabledState && getResources().getBoolean(R.bool.config_developer_options_switch)) {
    ...
    private void updateAllOptions() {
        ...
        if (mEnableOemUnlock != null) {
            ...
            //modify by xubinbin disable oem unlock
            if (getResources().getBoolean(R.bool.hct_disable_oem_unlock)){
    ...
    private void updateAnimationScaleValue(int which, ListPreference pref) {
        try {
            ...
            //if (scale != 1) {
            if (scale != 0.5f) {  //chenyichong modify 1->0.5, we should fit for mWindowAnimationScaleSetting = 0.5f;
                mHaveDebugSettings = true;
            }
    ...
    private void writeAnimationScaleOption(int which, ListPreference pref, Object newValue) {
        try {
            ...
            float scale = newValue != null ? Float.parseFloat(newValue.toString()) : (0.5f); //chenyichong modify 1->0.5, we should fit for mWindowAnimationScaleSetting = 0.5f;
