...
import com.hct.fuelgauge.BatteryPrecentDisplayExt;
...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    //yangguodong
    BatteryPrecentDisplayExt  mBatteryPrecentDisplayExt;
	...
	//yangguodong
	if(getResources().getBoolean(R.bool.config_show_battery_percent))
		mBatteryPrecentDisplayExt = new BatteryPrecentDisplayExt(getActivity(), mAppListGroup);
    }
	...
	//yangguodong
	if(getResources().getBoolean(R.bool.config_show_battery_percent) && mBatteryPrecentDisplayExt.onPowerUsageExtItemsClick(preferenceScreen, preference)){
            return super.onPreferenceTreeClick(preferenceScreen, preference);
        }
	...
	//yangguodong
	if(getResources().getBoolean(R.bool.config_show_battery_percent))
		mBatteryPrecentDisplayExt.initBatteryPrecentExtItems();
