...
public class AutoInterrpt {
	...
	private static String DEV_PATH = "DEVPATH=/devices/virtual/et300/esfp0";
	// For idea ˼·
	//private static String DEV_PATH = "DEVPATH=/devices/f9927000.spi/spi_master/spi5/spi5.0/fp/esfp0";
	...
	private void initLib() {
		...
		mLib.setStatusListener(new StatusListener() {
			...
			public void onServiceConnected() {
				...
				int result = mLib.removeCalibration();
				Log.d(TAG, "removecalibration result =" + result);
