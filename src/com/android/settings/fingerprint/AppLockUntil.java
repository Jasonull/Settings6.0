...
public class AppLockUntil {
    public static final String DBNAME = "lockappdb";
    ...
    public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.applock.database";  
    
    public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.applock.database";
    
    public static final String AUTHORITY = "com.android.applock.authority";  
