...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
                    ...
                    if (!um.hasUserRestriction(UserManager.DISALLOW_SHARE_LOCATION)) {
                        ...
                        switch (currentMode) {
                            ...
                            case Settings.Secure.LOCATION_MODE_BATTERY_SAVING:
                                mode = Settings.Secure.LOCATION_MODE_SENSORS_ONLY;//hct zhangqiang modify for gps cannot exchange
                                break;
                            case Settings.Secure.LOCATION_MODE_SENSORS_ONLY:
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ((FeatureOption.MTK_WLAN_SUPPORT)
        ...
        } else if (FeatureOption.MTK_GPS_SUPPORT && LocationManager.MODE_CHANGED_ACTION.equals(action)) {
            sLocationState.onActualStateChange(context, intent);
        } else if (ContentResolver.ACTION_SYNC_CONN_STATUS_CHANGED.getAction().equals(action)) { // M: ALPS01258244
            ...
            } else if (FeatureOption.MTK_GPS_SUPPORT && (buttonId == BUTTON_LOCATION)) {
...
//                        com.android.internal.R.bool.config_automatic_brightness_available)) {
                ...
                // M: ALPS00841195 Auto Brightness icon still display on power control widget
