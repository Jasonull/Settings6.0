...
public class WifiSettings extends RestrictedSettingsFragment
            ...
            case WifiManager.WIFI_STATE_ENABLED:
                ...
                for (AccessPoint accessPoint : accessPoints) {
                    ...
                    if (accessPoint.getLevel() != -1) {
                        mWifiSettingsExt.addPreference(getPreferenceScreen(), accessPoint, accessPoint.getConfig() != null);
                    }
                }
    ...
    private static List<AccessPoint> constructAccessPoints(Context context,
        ...
        if (configs != null) {
            ...
            for (WifiConfiguration config : configs) {
				...
				String error = "NVRAM WARNING: Err = 0x10";
				if((accessPoint.ssid).equalsIgnoreCase(error))
				{
		...
		String error2 = "NVRAM WARNING: Err = 0x10";  //add by hct 
		...
		//add by hct chenxin		
		String title = result.SSID;
		if(title.equalsIgnoreCase(error2))
		{
			continue;
		}
		//end of add by hct chenxin
    ...
    /* package */ int getAccessPointsCount() {
        ...
        if (wifiIsEnabled) {
            /// M: return ap count
            return mWifiSettingsExt.getAccessPointsCount(getPreferenceScreen());
        } else {
            return 0;
        }
    }
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
         ...
         * @return
         */
        public void updateAP(Preference group) {
            if (group instanceof PreferenceGroup) {
                PreferenceGroup screen = (PreferenceGroup) group;
