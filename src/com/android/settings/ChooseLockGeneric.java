...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
		...
		//HCT: xuejin fingerprint settings
        private static final String KEY_UNLOCK_FINGERPRINT = "unlock_fingerprint";
		//HCT: xuejin fingerprint settings
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (onlyShowFallback) {
                final String fallBackFor = getActivity().getIntent().getStringExtra(LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK_FOR);
                View header = null;
                if (fallBackFor.equals(LockPatternUtils.TYPE_FACE_UNLOCK)) {
                    header = v.inflate(getActivity(),
                            R.layout.weak_biometric_fallback_header, null);
                } else if (fallBackFor.equals(LockPatternUtils.TYPE_VOICE_UNLOCK)) {
                    header = v.inflate(getActivity(),
        ...
        protected void disableUnusablePreferencesImpl(final int quality,
            ...
            final boolean onlyShowFallback = intent.getBooleanExtra(
                    LockPatternUtils.LOCKSCREEN_WEAK_FALLBACK, false);//M: Modify for voice unlock
            ...
            for (int i = entries.getPreferenceCount() - 1; i >= 0; --i) {
                ...
                if (pref instanceof PreferenceScreen) {
					...
					//HCT: xuejin fingerprint settings 
					else if(KEY_UNLOCK_FINGERPRINT.equals(key)){
                    	enabled = quality <= DevicePolicyManager.PASSWORD_QUALITY_NUMERIC_COMPLEX;
        ...
        private boolean setUnlockMethod(String unlockMethod) {
            ...
            if(("1".equals(android.os.SystemProperties.get("ro.hct_fingerprint", "0"))) 
                && utils.isLockPinEnabled() && !KEY_UNLOCK_FINGERPRINT.equals(unlockMethod)){
            	onCreateDialogAlert(unlockMethod, getString(R.string.fingerprint_keyguard_method), getString(R.string.fingerprint_keyguard_content));
            }else 
			//HCT: xuejin fingerprint settings
            ...
            //HCT: xuejin fingerprint settings
            else if(KEY_UNLOCK_FINGERPRINT.equals(unlockMethod)){

            	Intent fingerprintIntent = new Intent("android.hybird.intent.action.FINGERPRINT");
            	fingerprintIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            	fingerprintIntent.putExtra("fingerprint_check", utils.isLockPinEnabled());
    	...
    	private void onCreateDialogAlert(final String key, String title, String context){
            ...
            b.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
    			...
    			public void onClick(DialogInterface dialog, int which) {
    				...
    				updateUnlockMethod(key);
                    android.provider.Settings.System.putInt(getActivity().getContentResolver(),"fingerprint_unlock_application", 0);
    			}
    		});
    	...
    	private void updateUnlockMethod(String unlockMethod){
            if (KEY_UNLOCK_SET_OFF.equals(unlockMethod)) {
                updateUnlockMethodAndFinish(
                        DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED, true /* disabled */ );
            } else if (KEY_UNLOCK_SET_NONE.equals(unlockMethod)) {
