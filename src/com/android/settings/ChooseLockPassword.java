...
public class ChooseLockPassword extends SettingsActivity {
    ...
    public static class ChooseLockPasswordFragment extends Fragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //HCT: xuejin add fingerprint applock password
			if("1".equals(android.os.SystemProperties.get("ro.hct_fingerprint", "0"))){
            	mFingerPrint = intent.getBooleanExtra("fingerprint_in", false);
			}
			//HCT: xuejin add fingerprint applock password
        }
        ...
        public void handleNext() {
			...
			Settings.System.putString(getActivity().getContentResolver(), commandKey, commandValue);
                    ...
                    Log.d(TAG, "saveLockPassword : pin " + pin + " mRequestedQuality : " + mRequestedQuality);
                    //M @}
                    //HCT: xuejin add fingerprint applock password
                    if("1".equals(android.os.SystemProperties.get("ro.hct_fingerprint", "0"))){
                    	if(mFingerPrint){
	    	            	...
	    	            	fingerprintIntent.putExtra("fingerprint_check", true);
	    	            	fingerprintIntent.putExtra("fingerprint", pin);
