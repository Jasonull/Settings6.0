...
public class Settings extends SettingsActivity {
    ...
    */
    ...
    /**@}*/
    public static class HctGestureMotionSettingActivity extends SettingsActivity { /* empty */ }
    //HCT: xuejin fingerprint settings
    public static class FingerPrintSettingsActivity extends SettingsActivity { /* empty */ }
    //HCT: xuejin fingerprint settings
    
	// HCT  lvcheng start
     public static class FloatViewActivity extends SettingsActivity { /* empty */ }
	 // HCT  lvcheng start
//hct macong add start
    public static class GestureListSettingsHct extends SettingsActivity{ /* empty */ }
    public static class GestureSettingsHct extends SettingsActivity{ /* empty */ }
//hct macong add end 
}
