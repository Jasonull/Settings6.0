...
public class Status extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (serial != null && !serial.equals("") && !getResources().getBoolean(R.bool.config_remove_serial_number)) {
		//xubinbin modify to set serial display imei1 number 2015-10-14
		if (getResources().getBoolean(R.bool.hct_serial_display_imei)){
		        int slotId = 0;
		        final Phone phone = PhoneFactory.getPhone(slotId);
	        if (phone != null) {
	           setSummaryText(KEY_SERIAL_NUMBER, phone.getImei());
			}
		} else {
